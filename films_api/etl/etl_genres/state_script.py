...
class BaseStorage:
    ...
    def save_state(state: dict) -> None:
        """Сохранить состояние в постоянное хранилище тут можно добавлять
        значения в json."""
...
class JsonFileStorage(BaseStorage):
    """будет сохранять данные в формате JSON в указанный файл (file_path) и
...
class State:
    ...
    Здесь представлена реализация с сохранением состояния в файл. В
    целом ничего не мешает поменять это поведение на работу с БД или
